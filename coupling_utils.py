...
am3 = Chem.MolFromSmarts("[CH2][CH1][NH1R1]")
...
def run_enumeration(file_tag, acid, amine, starting_numHs):
    index_start = file_tag * 1000000
    file_tag = str(file_tag).zfill(2)

    dmats = np.load(f"../../zzz_paper_quarantine_zone/rxn_mats/dmats_ac3_am3_{file_tag}.npy")
    out_file = open(f"./data_files/matrix_coupling_{file_tag}.csv","w")
